...
public class Tura {
    ...
    public void walka(Potwor potwor, javax.swing.JFrame frame) {
        if (KontrolerGry.gracz.poziomBojowy() > potwor.poziom) {
            ...
            Komunikat wygrana = new Komunikat(frame, "<html>Wygrałeś walkę!<br>Dostaniesz skarby i poziom!</html>", false);
    ...
    public boolean czyGraczJuzWygral(javax.swing.JFrame frame) {
        if (KontrolerGry.gracz.poziom >= 3){
            Komunikat wygrana = new Komunikat(frame, "<html>Wygrałeś!!!!!!!!<br>KONIEC!</html>", true);
            wygrana.setVisible(true);
            return true;
        }
        return false;
